...
"""
  this script is for issuing simple command line post request equivalent to curl.
  bash curl post command is hard b/c of the quotes and can not do nest json.
